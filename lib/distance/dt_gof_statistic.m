function [dn_sum, dn_max] = dt_gof_statistic(samples, samples2, dens, params, ...
...
for j = 1:directions 
    ...
    if ~two_sample
        ...
        % 2) use the analytic cdf formulas (in some special cases)
